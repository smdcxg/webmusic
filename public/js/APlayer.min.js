        ...
        var l = [], o = function() {
            function e(t) {
                ...
                this.lrcs = [], this.updateBar = function(e, t, a) {
					...
					var min, speed, max, scrolldown, sur;
                    ...
                    /*i.lrcContents.style.transform = "translateY(" + (30 * -i.lrcIndex + 150 - 15) + "px)", i.lrcContents.style.webkitTransform = "translateY(" + (30 * -i.lrcIndex + 150 - 15) + "px)", */
					//i.lrcContents.parentNode.scrollTop = (30 * i.lrcIndex - 150 - 15),
					min = i.lrcContents.parentNode.scrollTop,
				    speed = 1,
				    max = (30 * i.lrcIndex),
					console.log(min, max),
					scrolldown = function () {
					  scrolldown.A = function (){
						sur += speed;
						if(sur < max){
							i.lrcContents.parentNode.scrollTop = sur;
							setTimeout(scrolldown.A, 5);
						}
					  }
					  scrolldown.Q = function (){
						sur -= speed;
						if(sur < min){
							i.lrcContents.parentNode.scrollTop = sur; 
							setTimeout(scrolldown.Q, 5);
						}
					  }
					  if (min < max) { 
						sur = min;
                ...
                }, this.playIndex = 0, "[object Array]" !== Object.prototype.toString.call(t.music) && (this.option.music = [ this.option.music ]), 
                this.music = this.option.music[this.playIndex], /*this.option.showlrc && this.element.classList.add("aplayer-withlrc")  在音乐播放器中间添加歌词显示, */
                this.option.music.length > 1 && this.element.classList.add("aplayer-withlist"), 
                this.isMultiple() || "circulation" === this.mode || "order" === this.mode || (this.mode = "circulation"), 
                this.getRandomOrder();
                for (var y = '\n            <div class="aplayer-pic" ' + (this.music.pic ? "style=\"background-image: url('" + this.music.pic + "');\"" :"") + '>\n                <div class="aplayer-button aplayer-play">\n                    <button type="button" class="aplayer-icon aplayer-icon-play">\n                        ' + this.getSVG("play") + '\n                    </button>\n                </div>\n            </div>\n            <div class="aplayer-info">\n          <div class="aplayer-main-op">︽</div>\n                <div class="aplayer-music">\n                    <span class="aplayer-title"></span>\n                    <span class="aplayer-author"></span>\n                </div>\n                                <div class="aplayer-controller">\n                    <div class="aplayer-bar-wrap">\n                        <div class="aplayer-bar">\n                            <div class="aplayer-loaded" style="width: 0"></div>\n                            <div class="aplayer-played" style="width: 0; background: ' + this.option.theme + ';">\n                                <span class="aplayer-thumb" style="border: 1px solid ' + this.option.theme + ';"></span>\n                            </div>\n                        </div>\n                    </div>\n                    <div class="aplayer-time">\n                        <span class="aplayer-time-inner">\n                            - <span class="aplayer-ptime">00:00</span> / <span class="aplayer-dtime">00:00</span>\n                        </span>\n                        <div class="aplayer-volume-wrap">\n                            <button type="button" class="aplayer-icon aplayer-icon-volume-down" ' + (this.isMobile ? 'style="display: none;"' :"") + ">\n                               " + this.getSVG("volume-down") + '\n                            </button>\n                            <div class="aplayer-volume-bar-wrap">\n                                <div class="aplayer-volume-bar">\n                                    <div class="aplayer-volume" style="height: 80%; background: ' + this.option.theme + ';"></div>\n                                </div>\n                            </div>\n                        </div>\n                        <button type="button" class="aplayer-icon aplayer-icon-mode">\n                            ' + this.getSVG(this.mode) + '\n                        </button>\n                        <button type="button" class="aplayer-icon aplayer-icon-menu">\n                            ' + this.getSVG("menu") + '\n                        </button>\n                    </div>\n                </div>\n            </div>\n            <div class="aplayer-list aplayer-list-hide" ' + (this.option.listmaxheight ? 'style="max-height: ' + this.option.listmaxheight + '"' :"") + ">\n                <ol>", h = 0; h < this.option.music.length; h++) y += '\n                    <li>\n                        <span class="aplayer-list-cur" style="background: ' + this.option.theme + ';"></span>\n                        <span class="aplayer-list-index">' + (h + 1) + '</span>\n                        <span class="aplayer-list-title">' + this.option.music[h].title + '</span>\n                        <span class="aplayer-list-author">' + this.option.music[h].author + "</span>\n                    </li>";
                y += "\n                </ol>\n            </div>", y += '<div class="aplayer-main-win"><div class="amw-song-cover"><div class="wrapper">    <div class="border-circle" id="one"></div>    <div class="border-circle" id="two"></div>    <div class="background-circle">      <div class="triangle-light"></div>      <div class="body"></div>      <span class="shirt-text">M</span>      <span class="shirt-text">♥</span>      <span class="shirt-text">S</span>      <span class="shirt-text">I</span>      <span class="shirt-text">C</span>      <div class="triangle-dark"></div>    </div>    <div class="head">      <div class="ear" id="left"></div>      <div class="ear" id="right"></div>      <div class="hair-main">        <div class="sideburn" id="left"></div>        <div class="sideburn" id="right"></div>        <div class="hair-top"></div>      </div>      <div class="face">        <div class="hair-bottom"></div>        <div class="nose"></div>        <div class="eye-shadow" id="left">          <div class="eyebrow"></div>          <div class="eye"></div>        </div>        <div class="eye-shadow" id="right">          <div class="eyebrow"></div>          <div class="eye"></div>        </div>        <div class="mouth"></div>        <div class="shadow-wrapper">          <div class="shadow"></div>        </div>      </div>    </div>    <!--function paused(){    let a = $(\'.wrapper\').find(\'*\');    $(a).toggleClass(\'paused\');    }-->    <span class="music-note" id="one">&#9835;</span>    <span class="music-note" id="two">&#9834;</span>  </div><img width="100%" height:="100%" src="a" /></div><div class="amw-song-info"><div class="amw-song-info-title">title</div><div class="amw-song-info-lcr"><div class="aplayer-lrc">\n                    <div class="aplayer-lrc-contents" style="transform: translateY(0); -webkit-transform: translateY(0);"></div>\n                </div>\n</div></div><div class="amw-minimize"></div></div>', 
                this.element.innerHTML = y, this.element.offsetWidth < 300 && (this.element.getElementsByClassName("aplayer-icon-mode")[0].style.display = "none"), 
                ...
                var mob = {};
                mob.main_op_button = this.element.getElementsByClassName("aplayer-main-op")[0];
                mob.aplayer_main_win = document.getElementsByClassName("aplayer-main-win")[0];
                mob.main_op_button.addEventListener("click", function() {
                    mob.aplayer_main_win.classList.add("open");
                });
                mob.minimize = document.getElementsByClassName("amw-minimize")[0];
                mob.minimize.addEventListener("click", function() {
                    console.log(1);
                    mob.aplayer_main_win.classList.remove("open");
                });
                var m = {};
                ...
                A.addEventListener("click", function() {
                    i.isMultiple() ? "random" === i.mode ? i.mode = "single" :"single" === i.mode ? i.mode = "order" :"order" === i.mode ? i.mode = "circulation" :"circulation" === i.mode && (i.mode = "random") :"circulation" === i.mode ? i.mode = "order" :i.mode = "circulation", 
                    A.innerHTML = i.getSVG(i.mode), i.audio.loop = !(i.isMultiple() || "order" === i.mode);
                ...
                this.option.autoplay && this.play(), l.push(this);
            }
            return i(e, [ {
                key:"setMusic",
                value:function(e) {
                    ...
                    if (this.music = this.option.music[a], this.music.pic ? this.element.getElementsByClassName("aplayer-pic")[0].style.backgroundImage = "url('" + this.music.pic + "')" :this.element.getElementsByClassName("aplayer-pic")[0].style.backgroundImage = "", 
                    ...
                    this.isMobile && this.audio) this.audio.src = this.music.url; else if (!this.isMobile && this.audios[a]) this.audio = this.audios[a], 
                    this.audio.volume = parseInt(this.element.getElementsByClassName("aplayer-volume")[0].style.height) / 100, 
                    this.audio.currentTime = 0, this.audio.src = this.music.url; else {
                        this.audio = document.createElement("audio"), this.audio.src = this.music.url, this.audio.preload = this.option.preload ? this.option.preload :"auto", 
                        ...
                        this.audio.addEventListener("pause", n), this.audio.addEventListener("abort", n), 
                        this.audio.addEventListener("durationchange", function() {
                            ...
                            t.isMultiple() ? 0 !== t.audio.currentTime && ("random" === t.mode ? (t.setMusic(t.nextRandomNum()), 
                            t.play()) :"single" === t.mode ? (t.setMusic(t.playIndex), t.play()) :"order" === t.mode ? t.playIndex < t.option.music.length - 1 ? (t.setMusic(++t.playIndex), 
                            t.play()) :(t.ended = !0, t.pause(), t.trigger("ended")) :"circulation" === t.mode && (t.playIndex = (t.playIndex + 1) % t.option.music.length, 
                            t.setMusic(t.playIndex), t.play())) :"order" === t.mode && (t.ended = !0, t.pause(), 
                            t.trigger("ended"));
                        }), this.audio.volume = parseInt(this.element.getElementsByClassName("aplayer-volume")[0].style.height) / 100, 
                        this.audio.loop = !(this.isMultiple() || "order" === this.mode), this.audios[a] = this.audio;
                    }
                    var r = function(e) {
                    ...
                    if (this.option.showlrc) {
                        ...
                        if (!this.lrcs[i]) {
                            var o = "";
                            if (1 === this.option.showlrc) o = this.option.music[i].lrc; else if (2 === this.option.showlrc || !0 === this.option.showlrc) o = this.savelrc[i]; else if (3 === this.option.showlrc) {
                                var s = new XMLHttpRequest();
                                s.onreadystatechange = function() {
                                    if (4 === s.readyState) {
                                        s.status >= 200 && s.status < 300 || 304 === s.status ? (o = s.responseText, t.lrcs[i] = r(o)) :(console.log("Request was unsuccessful: " + s.status), 
                                        t.lrcs[i] = [ [ "00:00", "Not available" ] ]), t.lrc = t.lrcs[i];
                                        var e = "";
                                ...
                                var p = void 0;
                                p = this.option.music[i].lrc, s.open("get", p, !0), s.send(null);
                            }
                        ...
                        for (var u = 0; u < this.lrc.length; u++) c += "<p>" + this.lrc[u][1] + "</p>";
                        this.lrcContents.innerHTML = c, this.lrcIndex || (this.lrcIndex = 0), this.lrcContents.getElementsByTagName("p")[0].classList.add("aplayer-lrc-current"), 
                ...
                value:function() {
                    ...
                    this.isMultiple() && (this.randomOrder = function(t) {
                ...
                value:function(e) {
                    ...
                    for (var a = this.element.getElementsByClassName("aplayer-list")[0], n = a.getElementsByTagName("ol")[0], r = "", i = 0; i < e.length; i++) r += '\n                <li>\n                    <span class="aplayer-list-cur" style="background: ' + this.option.theme + ';"></span>\n                    <span class="aplayer-list-index">' + (this.option.music.length - e.length + i + 1) + '</span>\n                    <span class="aplayer-list-title">' + e[i].title + '</span>\n                    <span class="aplayer-list-author">' + e[i].author + "</span>\n                </li>";
                    n.innerHTML += r, t && this.isMultiple() && (this.element.classList.add("aplayer-withlist"), 
                    this.audio.loop = !1), a.style.height = "auto", /*a.style.height=a.offsetHeight+"px",*/
                    this.getRandomOrder();
                }
            } ]), e;
        }();
